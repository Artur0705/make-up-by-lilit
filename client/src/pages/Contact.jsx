...
const Contact = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    totalPeopleHair: "",
    timeToFinish: "",
    applicationAddress: "Lil's studio",
        ...
        <div className="max-w-2xl mx-auto text-zinc-500">
          ...
          >
            ...
            <input
              ...
              value={formData.totalPeopleMakeup}
              onChange={handleInputChange}
              placeholder="Total People for Makeup"
              className="w-full p-2 border border-gray-300 rounded bg-zinc-300"
              required
            />
            <input
              ...
              value={formData.totalPeopleHair}
              onChange={handleInputChange}
              placeholder="Total People for Hair"
              className="w-full p-2 border border-gray-300 rounded bg-zinc-300"
              required
            />
            <input
