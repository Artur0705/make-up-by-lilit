      ...
      <div className="bg-white p-6 rounded-lg max-w-xl w-full shadow-lg space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="flex items-center">
            <label
              className="text-gray-700 font-bold mr-2"
              htmlFor="totalPeopleMakeup"
            >
              Total People Makeup:
            </label>
            <span className="text-gray-600" id="totalPeopleMakeup">
              {enquiry.totalPeopleMakeup}
            </span>
          </div>
          <div className="flex items-center">
            <label
              className="text-gray-700 font-bold mr-2"
              htmlFor="totalPeopleHair"
            >
              Total People Hair:
            </label>
            <span className="text-gray-600" id="totalPeopleHair">
              {enquiry.totalPeopleHair}
            </span>
          </div>
          <div className="flex items-center">
            <label
            ...
            <span className="text-gray-600" id="timeToFinish">
              {enquiry.timeToFinish}
            </span>
          </div>
          <div className="flex items-center">
            <label
